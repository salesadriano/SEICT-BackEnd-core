...
@NoArgsConstructor
@Audited
@AuditTable(schema = "system_audit", value = "extra_permissions_audit")
@Table(name = "extra_permissions", schema = "system", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"user_id", "profile_action_id"})})
public class ExtraPermissions extends EntityBase implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ExtraPermissions that = (ExtraPermissions) o;
